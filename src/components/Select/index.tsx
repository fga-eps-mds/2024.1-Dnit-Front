    ...
    <div ref={wrapperRef} className="profile-type-select br-select" style={{ flexBasis: "90%" }}>
      <div className="br-input ">
        ...
        <div className="br-input large input-button">
          {inputReadOnly && <input id="select-simple" type="text" placeholder={definePlaceholder} value={getRotuloById(value, novaLista)} readOnly={inputReadOnly} style={inputStyle} />}
          {!inputReadOnly && <input id="select-simple" type="text" placeholder={definePlaceholder} onChange={e => onChange("", e.target.value)} value={getRotuloById(value, novaLista)} style={inputStyle} readOnly={!inputReadOnly} />}
