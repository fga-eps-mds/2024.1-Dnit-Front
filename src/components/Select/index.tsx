    ...
    <div ref={wrapperRef} className="profile-type-select br-select" style={{ flexBasis: "90%" }}>
      <div className="br-input ">
        ...
        <div className="br-input large input-button">
          ...
          {!inputReadOnly && <input id="select-simple" type="text" placeholder={definePlaceholder} onFocus={toggleDropdown} onChange={e => onChange("", e.target.value)} value={inputValue} style={inputStyle} readOnly={inputReadOnly} />}
